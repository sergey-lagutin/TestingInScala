...
import com.oreilly.testingscala.{JukeBox, Band, Track, Album}
...
class JukeboxUnitSpec extends Specification {
  "A Jukebox" should {
    """have a play method that returns a copy of the jukebox that selects
      ...
      jukeboxNext.currentTrack.get.period must be_==(new Period(0, 3, 49, 0)) //Must be 3 minutes and 49 seconds
    }
  }
}
